...
> 把 `2-3`、`/path/to/your/project`、`build/firmware.elf` 改成你的实际值。
...
1) 查看 USB 设备列表，找到 ST-Link 的 `BUSID`（形如 `2-3`）：
...
>
> ```powershell
> usbipd attach --wsl Ubuntu-22.04 --busid 2-3 --auto-attach
> ```
